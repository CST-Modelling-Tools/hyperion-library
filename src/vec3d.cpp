...
namespace hypl {
    constexpr vec3d vec3d::Zero(0., 0., 0.);
    constexpr vec3d vec3d::One(1., 1., 1.);
    constexpr vec3d vec3d::UnitX(1., 0., 0.);
    constexpr vec3d vec3d::UnitY(0., 1., 0.);
    constexpr vec3d vec3d::UnitZ(0., 0., 1.);
}
